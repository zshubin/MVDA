...
class OptInit:
    def __init__(self, sub, logger):
        ...
        parser.add_argument('--time_win', type=float, default=0.6, help='time window')
        ...
        #CDD args
        parser.add_argument('--clustering_eps', default=0.01, type=float, help='clustering threshold')
        parser.add_argument('--dist_type', default='cos', type=str, help='clustering distance type')
        parser.add_argument('--filtering_threshold', default=1e+6, type=int, help='threshold for clustering filtering')
        ...
        parser.add_argument('--max_iter_pretrain', default=200, type=int, help='max iter per CDD loop')
        parser.add_argument('--max_iter_train', default=10, type=int, help='max iter per CDD loop')
        ...
        args.save_dir = os.path.join('./DDGCNN_cross_sub_GMM/save_model/', sub)
        self.args = args
