...
from DDGCNN_cross_sub_MMD_3sub.cdd_model import Extractor, Predictor
from DDGCNN_cross_sub_MMD_3sub.config import OptInit
import logging
from data_loader_cross_sub.prepare_data import *
from DDGCNN_cross_sub_MMD_3sub.subject_measure import subject_sim_measure
from DDGCNN_cross_sub_MMD_3sub.can_solver import CANSolver as Solver
import sys
...
if __name__ == '__main__':
    ...
    record_file = open('./record_MSDA_0.8.txt','w')
