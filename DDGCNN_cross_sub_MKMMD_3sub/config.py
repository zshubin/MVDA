...
class OptInit:
    def __init__(self, sub, logger):
        ...
        parser.add_argument('--time_win', type=float, default=0.8, help='time window')
        ...
        #CDD args
        parser.add_argument('--clustering_eps', default=1e-2, type=float, help='clustering threshold')
