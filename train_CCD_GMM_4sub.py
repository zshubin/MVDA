...
from DDGCNN_cross_sub_GMM_4sub.cdd_model import Extractor, Predictor
from DDGCNN_cross_sub_GMM_4sub.config import OptInit
import logging
from data_loader_cross_sub.prepare_data import *
from DDGCNN_cross_sub_GMM_4sub.subject_measure import subject_sim_measure
from DDGCNN_cross_sub_GMM_4sub.can_solver import CANSolver as Solver
import sys
...
def train(logger, sess, source_sub, tar_sub, rest_sub,record_file,top_coff):
    ...
    train_solver = Solver(Extractor_model, Predictor_model, record_file, top_coff=top_coff, dataloader=dataloaders,
                          device=opt.device,
...
if __name__ == '__main__':
    ...
    record_file = open('./record_CAN_2fold.txt','w')
